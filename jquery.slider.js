...
; (function ($) {
    ...
    var Slider = function (el, opts) {
        ...
        var bindEvents = function () {
            $(".slider__nav--next", $element).on('click', function () { next(true); return false; });
            $(".slider__nav--prev", $element).on('click', function () { prev(true); return false; });
        ...
        var createNav = function () {
            if(options.showNav) {
                $element.append($("<div class='slider__nav slider__nav--next'><span></span></div>"));
                $element.append($("<div class='slider__nav slider__nav--prev'><span></span></div>"));
            }
